...
public class Mp4ComposerFork {
    ...
    private Mp4ComposerEngineFork engine;
    ...
    public Mp4ComposerFork(@NonNull final String srcPath, @NonNull final String destPath) {
        this(srcPath, destPath, new AndroidLogger());
    }

    public Mp4ComposerFork(@NonNull final String srcPath, @NonNull final String destPath, @NonNull final Logger logger) {
        this.logger = logger;
        this.srcDataSource = new FilePathDataSource(srcPath, logger, errorDataSource);
        this.destPath = destPath;
    }

    public Mp4ComposerFork(@NonNull final FileDescriptor srcFileDescriptor, @NonNull final String destPath) {
        this.srcDataSource = new FileDescriptorDataSource(srcFileDescriptor);
        this.destPath = destPath;
    }

    public Mp4ComposerFork(@NonNull final Uri srcUri, @NonNull final String destPath, @NonNull final Context context) {
        this(srcUri, destPath, context, new AndroidLogger());
    }

    public Mp4ComposerFork(@NonNull final Uri srcUri, @NonNull final String destPath, @NonNull final Context context, @NonNull final Logger logger) {
        this.logger = logger;
    ...
    public Mp4ComposerFork(@NonNull final FileDescriptor srcFileDescriptor, @NonNull final FileDescriptor destFileDescriptor) {
    ...
    @TargetApi(Build.VERSION_CODES.O)
    public Mp4ComposerFork(@NonNull final Uri srcUri, @NonNull final FileDescriptor destFileDescriptor, @NonNull final Context context) {
        this(srcUri, destFileDescriptor, context, new AndroidLogger());
    }

    @TargetApi(Build.VERSION_CODES.O)
    public Mp4ComposerFork(@NonNull final Uri srcUri, @NonNull final FileDescriptor destFileDescriptor, @NonNull final Context context, @NonNull final Logger logger) {
        if (Build.VERSION.SDK_INT < 26) {
            throw new IllegalArgumentException("destFileDescriptor can not use");
        }
        this.logger = logger;
    ...
    public Mp4ComposerFork filter(@NonNull GlFilter filter) {
        this.filter = filter;
        return this;
    }

    public Mp4ComposerFork size(int width, int height) {
        this.outputResolution = new Size(width, height);
        return this;
    }

    public Mp4ComposerFork videoBitrate(int bitrate) {
        this.bitrate = bitrate;
        return this;
    }

    public Mp4ComposerFork mute(boolean mute) {
        this.mute = mute;
        return this;
    }

    public Mp4ComposerFork flipVertical(boolean flipVertical) {
        this.flipVertical = flipVertical;
        return this;
    }

    public Mp4ComposerFork flipHorizontal(boolean flipHorizontal) {
        this.flipHorizontal = flipHorizontal;
        return this;
    }

    public Mp4ComposerFork rotation(@NonNull Rotation rotation) {
        this.rotation = rotation;
        return this;
    }

    public Mp4ComposerFork fillMode(@NonNull FillMode fillMode) {
        this.fillMode = fillMode;
        return this;
    }

    public Mp4ComposerFork customFillMode(@NonNull FillModeCustomItem fillModeCustomItem) {
    ...
    public Mp4ComposerFork listener(@NonNull Listener listener) {
        this.listener = listener;
        return this;
    }

    public Mp4ComposerFork timeScale(final float timeScale) {
        this.timeScale = timeScale;
        return this;
    }

    public Mp4ComposerFork changePitch(final boolean isPitchChanged){
        this.isPitchChanged = isPitchChanged;
        return this;
    }

    public Mp4ComposerFork videoFormatMimeType(@NonNull VideoFormatMimeType videoFormatMimeType) {
     ...
     */
    public Mp4ComposerFork logger(@NonNull final Logger logger) {
        this.logger = logger;
        return this;
    }
     ...
     * @return The composer instance.
     */
    public Mp4ComposerFork trim(final long trimStartMs, final long trimEndMs) {
        this.trimStartMs = trimStartMs;
        this.trimEndMs = trimEndMs;
        return this;
    }

    public Mp4ComposerFork shareContext(@NonNull EGLContext shareContext) {
    ...
    public Mp4ComposerFork start() {
        ...
        getExecutorService().execute(new Runnable() {
            ...
            public void run() {
                ...
                engine = new Mp4ComposerEngineFork(logger);
